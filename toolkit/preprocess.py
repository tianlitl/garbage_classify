...
data_path = '/data/multi_task/Ubuntu_Code/garbage_classify/Data'
...
for train_img_label in train_data:
    ...
    shutil.copy(img_path, '/data/multi_task/Ubuntu_Code/garbage_classify/DataSet/TrainData')
    label_path,_ = img_path.split('.')
    # print(label_path)
    label_path = label_path+'.txt'
    shutil.copy(label_path,'/data/multi_task/Ubuntu_Code/garbage_classify/DataSet/TrainData')
for test_img_label in val_data:
    # print(train_img_label)
    img_path, label = test_img_label.split(',')
    print(img_path)
    shutil.copy(img_path, '/data/multi_task/Ubuntu_Code/garbage_classify/DataSet/TestData')
    label_path, _ = img_path.split('.')
    # print(label_path)
    label_path = label_path + '.txt'
    shutil.copy(label_path, '/data/multi_task/Ubuntu_Code/garbage_classify/DataSet/TestData')
    print(label_path)
...
def _eval(model, dataloader):
    ...
    for test_data in dataloader:
        ...
        # y_pred = model(X)
        output_concat = model(X)
        outputs_com = output_concat
...
if __name__ == '__main__':
    # creat train dataset
    data_path = '/data/multi_task/Ubuntu_Code/garbage_classify/DataSet/TrainData'
    test_data = '/data/multi_task/Ubuntu_Code/garbage_classify/DataSet/TestData'
    ...
    model._fc = nn.Linear(num_ftrs, 43) #修改为相应的类别数
    # print(model)
